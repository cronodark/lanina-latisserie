...
@section('title', 'Dikemas')

@section('content')

    <div class="min-h-screen bg-[#FBFEF3]">

        <x-sidebar active="diproses" />
    ...
    <script>
        {
            ...
            function konfirmasiPesanan(index) {
                Swal.fire({
                    ...
                    text: 'Apakah pesanan ini sudah diterima dengan baik?',
                    icon: 'question',
            ...
            window.konfirmasiPesanan = konfirmasiPesanan;
        }
    </script>
