        ...
        <div class="lg:ml-[230px] flex flex-col gap-5 px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <div class="flex items-center gap-4 mb-2">
                ...
                <div class="flex-1 max-w-[300px]">
                    <div
                        class="flex items-center gap-2 bg-[#F5F6FA] border border-[#D5D5D5] rounded-full px-4 py-2 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                        <svg class="w-4 h-4 text-[#9A8878]" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            stroke-width="2">
            ...
            {{-- Profile Banner --}}
            <div
                class="bg-[#BB9457] rounded-[20px] font-nunito px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 shadow-[0_4px_20px_rgba(0,0,0,0.1)]">
                <div
                    class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-white/20 overflow-hidden shrink-0 ring-4 ring-white/30">
                    <img src="https://api.dicebear.com/7.x/adventurer/svg?seed=maimunah" alt="Avatar"
                        class="w-full h-full object-cover">
                </div>
                <div class="flex-1  text-center sm:text-left">
                    <h2 class="font-bold text-white text-xl sm:text-2xl">Maimunah Pasutri Gaje
                    </h2>
                    <p class="font-semibold text-white/80 text-sm mt-0.5">Admin</p>
                </div>
                <div class="text-center sm:text-right mt-2 sm:mt-0">
                    <p class="font-bold text-white/90 text-sm">maimunah@gmail.com</p>
                    <p class="font-bold text-white/90 text-sm mt-1">+62 877 4563 4859</p>
                </div>
            </div>

            {{-- Pesanan Saya --}}
<div
    class="bg-[#FCFFF4]/40 rounded-[20px] font-glacial px-4 sm:px-6 lg:px-8 py-6 lg:py-7 card-shadow">

    <h2 class="font-bold text-[#3D2B1F] text-xl sm:text-2xl mb-4 sm:mb-6">
        Pesanan Saya
    </h2>
    ...
    <div class="flex flex-wrap justify-center sm:justify-around gap-6">
        ...
        <a href="#" class="flex flex-col items-center gap-3 group">
            <div
                class="w-16 h-16 rounded-[16px] flex items-center justify-center transition-all duration-300 group-hover:scale-105">
                <svg class="w-10 h-10" viewBox="0 0 64 64" fill="none"
                    ...
                    <path
                        ...
                        stroke="#6A7941" stroke-width="7" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </div>
            <span class="font-bold text-[#3D2B1F] text-xs">
                Belum Bayar
            </span>
        </a>
        ...
        <a href="#" class="flex flex-col items-center gap-3 group">
            <div
                class="w-16 h-16 rounded-[16px] flex items-center justify-center transition-all duration-300 group-hover:scale-105">
                <svg class="w-10 h-10" viewBox="0 0 67 71" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <a href="#" class="flex flex-col items-center gap-3 group">
            <div
                class="w-16 h-16 rounded-[16px] flex items-center justify-center transition-all duration-300 group-hover:scale-105">
                <svg class="w-10 h-10" viewBox="0 0 71 53" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <a href="#" class="flex flex-col items-center gap-3 group">
            <div
                class="w-16 h-16 rounded-[16px] flex items-center justify-center transition-all duration-300 group-hover:scale-105">
                <svg class="w-10 h-10" viewBox="0 0 60 60" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            {{-- Alamat Saya --}}
            <div class="bg-white rounded-[20px] px-4 sm:px-6 lg:px-8 py-6 lg:py-7 card-shadow">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 mb-4 sm:mb-5">
                    <h2 class="font-glacial text-[#3D2B1F] text-xl sm:text-2xl">Alamat Saya</h2>
                    <button
                        class="bg-[#7A8C5C] hover:bg-[#5C6B44] text-white font-glacial text-xs font-bold px-4 sm:px-5 py-2 sm:py-2.5 rounded-full transition-colors self-start sm:self-auto">
                        + Tambah Alamat
                    </button>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1 font-poppins">
                        <div class="flex items-center gap-1">
                            <p class="font-bold text-[#3D2B1F] text-sm">Maimunah Pasutri Gaje</p>
                            <span class="text-[#6B4C3B] font-medium text-sm">(+62 083 7439 2934)</span>
                            <svg class="w-4 h-4 text-[#3D2B1F] ml-1" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                            </svg>
                        </div>
                        <p class="text-[#6B4C3B] text-sm mt-1 leading-relaxed">
            ...
            {{-- Info Personal --}}
            <div class="bg-[#E2E3E4]/40 font-nunito rounded-[20px] px-4 sm:px-6 lg:px-8 py-6 lg:py-7 card-shadow">

                <h2 class="font-bold text-[#3D2B1F] text-lg sm:text-xl mb-1">Info Personal</h2>
                <hr class="border-[#979797] mb-4 sm:mb-6">

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 sm:mb-8">
                    <div>
                        <label class="text-md mb-1.5 block">Nama lengkap</label>
                        <input type="text" placeholder="Masukan Nama Anda"
                            class="w-full text-sm text-[#3D2B1F] bg-[#F5F6F7] border border-[#979797]/20 rounded-[10px] px-4 py-3 outline-none focus:border-[#7A8C5C] transition-colors">
                    </div>
                    <div>
                        <label class="text-md mb-1.5 block">Nomor Telepon</label>
                        <input type="text" placeholder="Masukan Nomor Telepon Anda"
                            class="w-full text-sm text-[#3D2B1F] bg-[#F5F6F7] border border-[#979797]/20 rounded-[10px] px-4 py-3 outline-none focus:border-[#7A8C5C] transition-colors">
                    </div>
                </div>

                <h2 class="font-bold text-[#3D2B1F] text-xl mb-1">Autentifikasi</h2>
                <hr class="border-[#979797] mb-6">

                <div class="mb-4">
                    <label class="text-md mb-1.5 block">Email</label>
                    <input type="email" placeholder="Masukan Email anda"
                        class="w-full text-sm text-[#3D2B1F] bg-[#F5F6F7] border border-[#979797]/20 rounded-[10px] px-4 py-3 outline-none focus:border-[#7A8C5C] transition-colors">
                </div>

                {{-- Password hint --}}
                <div class="bg-[#48B3FF]/20 border border-[#48B3FF] rounded-[10px] px-5 py-3.5 mb-4">
                    <p class="text-[#0D80D2] text-sm">Kosongkan jika tidak ingin mengubah password</p>
                </div>

                <div class="grid grid-cols-2 gap-4 mb-8">
                    <div>
                        <label class="text-md mb-1.5 block">Password</label>
                        <input type="password" placeholder="••••••"
                            class="w-full text-sm text-[#3D2B1F] bg-[#F5F6F7] border border-[#979797]/20 rounded-[10px] px-4 py-3 outline-none focus:border-[#7A8C5C] transition-colors">
                    </div>
                    <div>
                        <label class="text-md mb-1.5 block">Konfirmasi Password</label>
                        <input type="password" placeholder="••••••"
                            class="w-full text-sm text-[#3D2B1F] bg-[#F5F6F7] border border-[#979797]/20 rounded-[10px] px-4 py-3 outline-none focus:border-[#7A8C5C] transition-colors">
                    </div>
                </div>
                ...
                {{-- Foto Profile --}}
                <h2 class="font-bold text-[#3D2B1F] text-xl mb-4">Foto Profile</h2>
                <div class="flex items-center gap-5">
                    {{-- Avatar --}}
                    <div class="w-20 h-20 rounded-full overflow-hidden shrink-0 ring-2 ring-[#E8E0D4]">
                        <img src="https://api.dicebear.com/7.x/adventurer/svg?seed=maimunah" alt="Avatar"
                            class="w-full h-full object-cover">
                    </div>

                    {{-- Choose File --}}
                    <div class="flex-1 bg-[#F5F6F7] border border-[#979797]/20 rounded-[12px] px-5 py-4">
                        <div class="flex items-center gap-3 mb-1">
                            <label
                                class="bg-[#48B3FF]/20 text-sm text-[#0D80D2] px-4 py-1.5 rounded-[8px] cursor-pointer hover:bg-[#48B3FF] hover:text-white transition-colors">
                                Choose File
                                <input type="file" class="hidden" accept=".jpg,.jpeg,.png">
                            </label>
                            <span class="text-sm">No file Chosen</span>
                        </div>
                        <p class="font-bold text-black/80 text-xs mt-2">Format: JPG, JPEG, PNG. Max: 2MB</p>
                    </div>
                    <div class="w-32 h-22 bg-[#68C0FF] rounded-[12px] text-center justify-center flex cursor-pointer hover:bg-[#48B3FF] transition-colors">
                        <button
                            class="text-white font-bold text-sm px-20 py-2.5 cursor-pointer">
                            Simpan
                        </button>
                    </div>
