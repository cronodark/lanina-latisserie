                ...
                <form action="{{ route('register.submit') }}" method="POST" class="font-poppins font-medium lg:mt-4 sm:mt-5 lg:space-y-2 sm:space-y-6">
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" value="{{ old('phone') }}"
                            inputmode="numeric" minlength="9" maxlength="13" pattern="[0-9]{9,13}" required
                    ...
                    <!-- BUTTON -->
                    <button type="submit"
                        class="mt-6 w-full font-nunito font-bold sm:w-2/3 lg:w-4/5 mx-auto block rounded-lg bg-[#6A7941] py-3 text-sm sm:text-base font-semibold text-white hover:bg-[#5E702A] transition duration-300 shadow-md hover:shadow-lg cursor-pointer">
                        Daftar
                    </button>
