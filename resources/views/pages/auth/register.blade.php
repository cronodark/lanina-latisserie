        ...
        <div class="flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 2xl:px-32 py-10 bg-[#ADC178]">
            <div class="w-full max-w-md sm:max-w-lg lg:max-w-xl">
                ...
                <form action="{{ route('register.submit') }}" method="POST" class="lg:mt-4 sm:mt-5 lg:space-y-2 sm:space-y-6">
                    ...
                    <!-- BUTTON -->
                    <button type="submit"
                        class="mt-6 w-full sm:w-2/3 lg:w-4/5 mx-auto block rounded-lg bg-[#6A7941] py-3 text-sm sm:text-base font-semibold text-white hover:bg-[#5E702A] transition duration-300 shadow-md hover:shadow-lg cursor-pointer">
                        Daftar
                    </button>
